package com.java.antu.swagger.controller;
...
import com.java.antu.swagger.exception.ResourceNotFoundException;
import com.java.antu.swagger.model.Employee;
import com.java.antu.swagger.repository.EmployeeRepository;
...
public class EmployeeController {
 ...
 public ResponseEntity<Employee> updateEmployee(
   ...
   @ApiParam(value = "Update employee object", required = true) @Validated @RequestBody Employee employeeDetails) throws ResourceNotFoundException {
  Employee employee = employeeRepository.findById(employeeId)
    .orElseThrow(() -> new ResourceNotFoundException("Employee not found for this id :: " + employeeId));
 ...
 @ApiOperation(value="Delete particular empid")
